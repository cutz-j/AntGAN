...
class MotionDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        if self.is_train and os.path.isdir(path):
            ...
            video_array = video_array[frame_idx] # (1, w, h, c) // (frame, w, h, c)
            target_video_array = video_array[target_frame_idx:target_frame_idx+self.K] # (K, w, h, c)
        ...
        out = {}
        if self.is_train:
            out['source'] = video_array[0] # (c, w, h)
